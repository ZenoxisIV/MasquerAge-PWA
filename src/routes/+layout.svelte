<script lang="ts">
	...
	import { DarkMode, Footer, FooterIcon, FooterCopyright } from 'flowbite-svelte';
...
<div class="flex flex-col min-h-screen">
	...
	{#if !page.error}
		<Footer footerType="sitemap">
			<div class="py-6 px-4 bg-primary-50 dark:bg-[#0f1c24] md:flex md:items-center md:justify-between relative">
				<div class="absolute bottom-4 right-4 md:static flex pt-2 space-x-6 rtl:space-x-reverse sm:justify-center md:mt-0">
					<DarkMode />
				</div>
